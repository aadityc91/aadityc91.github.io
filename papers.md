...
<div style="margin-bottom: 2rem;">
  ...
  <p style="margin-top:0.5rem; font-size:0.9rem; color:var(--color-global-text); opacity:0.7;">
    ICEIS — 27th International Conference on Enterprise Information Systems
  </p>
</div>
...
<div style="margin-bottom: 2rem;">
  ...
  <p style="margin-top:0.5rem; font-size:0.9rem; color:var(--color-global-text); opacity:0.7;">
    DATA — 15th International Conference on Data Science, Technology and Applications
  </p>
</div>
